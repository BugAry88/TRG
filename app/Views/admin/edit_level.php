...
<head>
    ...
    <title>Edit Level - LP12 Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Edit Level</h1>
                    <p class="text-muted mb-0">Modify LP12 performance level</p>
                </div>
                <div>
        ...
        <div class="level-info">
            <div class="row">
                <div class="col-md-6">
                    <strong>Level ID:</strong> <?= $level['id'] ?>
                </div>
                <div class="col-md-6">
                    <strong>Current Name:</strong> <?= esc($level['name']) ?>
                </div>
            </div>
        </div>
        ...
        <div class="form-container">
            <form action="<?= base_url('admin/edit-level/' . $level['id']) ?>" method="POST">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            <label for="name" class="form-label">Level Name</label>
                            <input type="text" class="form-control" id="name" name="name" 
                                   value="<?= esc($level['name']) ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control" id="base_price" name="base_price" 
                                   value="<?= $level['base_price'] ?>" step="0.01" min="0" required>
