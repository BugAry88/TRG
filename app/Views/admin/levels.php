    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Manage Levels</h1>
                    <p class="text-muted mb-0">Configure LP12 performance levels</p>
                </div>
                <div>
                    <a href="<?= base_url('admin/create-level') ?>" class="btn-primary-custom me-2">
                        ...
                        <?php if($levels && count($levels) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <small class="text-muted">Level <?= $level['id'] ?></small>
                                </td>
                                <td>
                                    <span class="badge-level">฿<?= number_format($level['base_price'], 2) ?></span>
                                </td>
                                <td>
                                    <span class="badge bg-success">Active</span>
                                </td>
                                <td>
                                    <a href="<?= base_url('admin/edit-level/' . $level['id']) ?>" class="btn-action btn-edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?= base_url('admin/delete-level/' . $level['id']) ?>" 
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="text-center py-4">
                                    ...
                                    <p class="text-muted">No levels found. <a href="<?= base_url('admin/create-level') ?>">Add your first level</a></p>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
