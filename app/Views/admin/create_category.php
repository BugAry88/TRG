...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Add a new component category</p>
                </div>
                <div>
        ...
        <div class="form-container">
            <form action="<?= base_url('admin/create-category') ?>" method="POST">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="display_order" id="display_order" class="form-control" min="1" required>
                        <small class="text-muted">Order in which this category appears (1 = first)</small>
                    </div>
                    
                    <div class="col-12">
                        <label for="description" class="form-label">Description</label>
                        <textarea name="description" id="description" class="form-control" rows="4" placeholder="Describe this component category..."></textarea>
