...
<head>
    ...
    <style>
        ...
        .preview-wrap { display: none; align-items: center; gap: 12px; margin-bottom: 10px; }
    </style>
</head>
<body>
    <div class="sidebar">
    ...
    <div class="main-content">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Create New Component</h1>
                    <p class="text-muted mb-0">Add a new component to the configurator</p>
                </div>
                <div>
        ...
        <div class="form-container">
            <form action="<?= base_url('admin/create-component') ?>" method="POST" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="price_modifier" id="price_modifier" class="form-control" step="0.01" min="0" required>
                        <small class="text-muted">Additional cost for this component (0 for base component)</small>
                    </div>
                    
                    <div class="col-md-6">
                        <label class="form-label">Component Image <small class="text-muted fw-normal">(optional)</small></label>
                ...
                <div class="d-flex gap-3 mt-4">
                    <button type="submit" class="btn-primary-custom">
                        <i class="fas fa-save me-2"></i>Create Component
                    </button>
